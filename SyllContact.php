<?php
    ...
    if(isset($_POST['objsubmit'])){
        ...
        if($query){            
            echo '<script>alert("Succesfully Updated!");
            location.href="SyllContact.php?subid='.$_SESSION['subid'].'";
              </script>';
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <ul class="nav nav-tabs" role="tablist">            
        ...
        <li role="presentation"><a href="Activities.php?subid=<?php echo $_SESSION['subid']?>">Activities</a></li>
        <li role="presentation"><a href="SyllReference.php?subid=<?php echo $_SESSION['subid']?>">Reference</a></li>          
        <li role="presentation" class="active"><a href="SyllContact.php?subid=<?php echo $_SESSION['subid']?>">Contact</a></li>          
    </ul> 
    <br/>
    <div class="col-md-8" style="padding: 0">
        ...
        <!-- </form> -->
            ...
            <div id="id04" class="modal" style="display:none">
                ...
                <form class="col-sm-6 modal-content animate" id="form4" method="POST" style="display:none" enctype="multipart/form-data"><!-- importante to sa upload -->
                            ...
                            <select type="text" name="actmod" class="form-control" required>
                                ...
                                ?>
                                <option value="<?php echo $row1['MODULE_NO']?>"><?php echo $row1['TITLE']?></option>
                                <?php
                                    }
                                ?>
                            </select>                                 
            ...
            <button class="btn btn-success" onclick="location.href='complete.php?subid=<?php echo $_SESSION['subid']?>'"><span class="glyphicon glyphicon-floppy-disk"></span> Save Syllabus</button>
    </div>
</div>
