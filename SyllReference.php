<?php
    ...
    if(isset($_POST['objsubmit'])){
        ...
        if($query){            
            echo '<script>alert("Succesfully Updated!");
            location.href="SyllReference.php?subid='.$_SESSION['subid'].'";
              </script>';
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <ul class="nav nav-tabs" role="tablist">            
        ...
        <li role="presentation" class="active"><a href="SyllReference.php?subid=<?php echo $_SESSION['subid']?>">Reference</a></li>          
